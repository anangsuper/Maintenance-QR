    ...
    <div class="col-md-6 col-lg-4">
      <div class="card card-hover p-4 h-100 '.($isCurrent ? 'border-primary border-2 shadow' : '').'">
        ...
        <div class="d-flex gap-2 mt-auto pt-2 border-top">
          ...
          <a class="btn btn-sm btn-outline-primary" target="_blank" href="'.e(module_url('print_card.php', ['cabang'=>$bId, 'layout'=>'grid8', 'tahun'=>$year])).'" title="Cetak Semua Kartu"><i class="bi bi-card-checklist"></i></a>
